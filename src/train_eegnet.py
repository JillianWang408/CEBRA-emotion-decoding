...
def main():
    ...
    X_train, y_train = create_windows(neural_train, emotion_train, args.window_size, args.stride)
    X_test, y_test = create_windows(neural_test, emotion_test, args.window_size, args.stride)
